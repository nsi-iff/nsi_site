...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('projects_project', 'github', self.gf('django.db.models.fields.CharField')(max_length=80, null=True, blank=True), keep_default=False)
    ...
    models = {
        ...
        'projects.project': {
            ...
            'github': ('django.db.models.fields.CharField', [], {'max_length': '80', 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
