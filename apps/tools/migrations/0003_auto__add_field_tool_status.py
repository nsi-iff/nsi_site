...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Tool.status'
        db.add_column('tools_tool', 'status', self.gf('django.db.models.fields.CharField')(default='ativo', max_length=100), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Tool.status'
        db.delete_column('tools_tool', 'status')
