Feature: Member maintenance
  ...
  Scenario: member page that just have only one team
    Given exist a member:
      ...
      | Pluck | Renapi | Phd em Desenvolvimento de software, bolsista do NSI desde das trevas | Atualmente trabalha como suporte de madeira | http://www.pluck.com | http://github.com/pluck | http://twitter.com/pluck | http://slideshare.com/pluck | http://lattes.cnpq.br/pluck | images/members/pluck_photo.png | Biblioteca Digital | 2000-01-01  |  
